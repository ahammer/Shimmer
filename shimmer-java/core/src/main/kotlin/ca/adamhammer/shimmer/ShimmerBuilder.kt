...
import ca.adamhammer.shimmer.adapters.CachingAdapter
import ca.adamhammer.shimmer.context.DefaultContextBuilder
import ca.adamhammer.shimmer.context.InMemoryStore
...
import ca.adamhammer.shimmer.interfaces.TypeAdapter
import ca.adamhammer.shimmer.model.PromptContext
import ca.adamhammer.shimmer.model.ResiliencePolicy
import ca.adamhammer.shimmer.model.ShimmerConfigurationException
import ca.adamhammer.shimmer.model.TypeAdapterRegistry
...
class ShimmerBuilder<T : Any>(private val apiInterface: KClass<T>) {
    ...
    fun adapter(router: (PromptContext) -> ApiAdapter): ShimmerBuilder<T> {
        this.adapter = ca.adamhammer.shimmer.adapters.RoutingAdapter(router)
        return this
    }
