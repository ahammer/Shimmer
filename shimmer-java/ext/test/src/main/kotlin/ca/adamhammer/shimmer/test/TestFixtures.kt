...
import ca.adamhammer.shimmer.adapters.StubAdapter
...
interface StreamingTestAPI {
    @AiOperation(summary = "Stream", description = "Streams a response")
    fun stream(): Flow<String>

    @AiOperation(summary = "StreamWithParam", description = "Streams a response with a parameter")
    fun streamWithParam(
        @AiParameter(description = "An input string") input: String
    ): Flow<String>
}
