package com.adamhammer.shimmer.mcp
...
import com.adamhammer.shimmer.utils.toToolDefinitions
...
class ShimmerMcpServerTest {
    ...
    fun `ToolCall and ToolResult data classes work correctly`() {
        ...
        val result = com.adamhammer.shimmer.model.ToolResult("id-1", "my_tool", "success", false)
