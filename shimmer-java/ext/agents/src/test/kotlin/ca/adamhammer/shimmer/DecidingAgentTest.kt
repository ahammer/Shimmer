...
import ca.adamhammer.shimmer.agents.*
import ca.adamhammer.shimmer.test.MockAdapter
import ca.adamhammer.shimmer.test.SimpleResult
import ca.adamhammer.shimmer.test.assertMethodInvocationContains
...
class DecidingAgentTest {
    ...
    fun `decide extension function creates proper schema from ShimmerInstance`() {
        ...
        val targetInstance = ShimmerBuilder(ca.adamhammer.shimmer.test.SimpleTestAPI::class)
