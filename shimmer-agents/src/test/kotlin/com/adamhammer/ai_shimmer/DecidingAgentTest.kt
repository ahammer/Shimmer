...
import com.adamhammer.ai_shimmer.test.assertMethodInvocationContains
...
class DecidingAgentTest {
    ...
    fun `decide extension function creates proper schema from ShimmerInstance`() {
        ...
        val targetInstance = ShimmerBuilder(com.adamhammer.ai_shimmer.test.SimpleTestAPI::class)
